...
contract InvariaOpenInvariantsTest is StdInvariant, Test {
    ...
    //     uint256 totalSupplyWETH = IERC20(weth).balanceOf(address(weth));
    //     uint256 totalSupplyWBTC = IERC20(wbtc).balanceOf(address(wbtc));
    ...
    //     console.log(totalWETHValue);
    //     console.log(totalWBTCValue);
